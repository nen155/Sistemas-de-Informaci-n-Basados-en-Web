...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderBrowse: function () {
            ...
            return '<div class="' + css + ' btn-sm"' + status + '> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
        renderRemove: function () {
            ...
            return '<button type="button" title="' + self.removeTitle + '" class="' + css + ' btn-sm"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        removeTitle: 'Eliminar Selección',
        ...
        msgInvalidFileType: 'Archivo no valido "{name}". Solo soporta archivos "{types}" .',
        msgInvalidFileExtension: 'Archivo no valido "{name}". Solo soporta archivos con extensión "{extensions}".',
        ...
        dropZoneTitle: 'Arrastra la imagen aquí',
