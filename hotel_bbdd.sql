...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2016 a las 12:20:45
...
DROP USER IF EXISTS 'hotel_plaza'@'localhost';
CREATE USER 'hotel_plaza'@'localhost' IDENTIFIED BY 'JulianEmilio!1234';GRANT USAGE ON *.* TO 'hotel_plaza'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `hotel`.* TO 'hotel_plaza'@'localhost';
USE `hotel`;
...
INSERT INTO `cliente` (`id`, `nombre`, `apellidos`, `telefono`, `direccion`, `ciudad`, `pais`, `dniPasaporte`, `codigoPostal`) VALUES
(1, 'Pepe', 'Perez', '987645321', 'C/ Poeta 19', 'Granada', 'España', '741852963-G', '18008');
...
INSERT INTO `habitacion` (`id`, `numero`, `id_tipoHabitacion`) VALUES
(1, 20, 1),
(2, 22, 1);
...
(5, '2016-05-30', '2016-05-31', NULL, 0, 4, 0);
...
(1, 'melero@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220');
